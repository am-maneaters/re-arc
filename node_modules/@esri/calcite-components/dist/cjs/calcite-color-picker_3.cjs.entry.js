...
const utils = require('./utils-51c079f6.js');
const math = require('./math-9d6de52c.js');
const interactive = require('./interactive-e294111f.js');
const debounce = require('./debounce-94d2834e.js');
...
const ColorPickerHexInput = class {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS$1.container }, index.h("calcite-input", { class: CSS$1.input, label: intlHex, maxLength: 6, onCalciteInputBlur: this.onCalciteInputBlur, onCalciteInputChange: this.onInputChange, onKeyDown: this.handleKeyDown, prefixText: "#", ref: this.storeInputRef, scale: this.scale, value: hexInputValue }), hexInputValue ? (index.h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: this.scale })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
