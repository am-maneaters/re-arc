 ...
 * v1.0.0-beta.82
 */
import { r as registerInstance, c as createEvent, h, g as getElement } from './index-8ece2564.js';
import { a as getElementDir, f as focusElement, b as getThemeName } from './dom-da697a3f.js';
import { n as normalizeHex, C as CSSColorMode, p as parseMode, c as colorEqual, i as isValidHex, a as isLonghandHex, r as rgbToHex, b as hexChar } from './utils-040a2a22.js';
import { c as clamp } from './math-2e4483eb.js';
import { u as updateHostInteraction } from './interactive-cb5bf285.js';
import { d as debounce, i as isObject } from './debounce-c4df98cc.js';
...
const ColorPickerHexInput = class {
  ...
  render() {
    ...
    return (h("div", { class: CSS$1.container }, h("calcite-input", { class: CSS$1.input, label: intlHex, maxLength: 6, onCalciteInputBlur: this.onCalciteInputBlur, onCalciteInputChange: this.onInputChange, onKeyDown: this.handleKeyDown, prefixText: "#", ref: this.storeInputRef, scale: this.scale, value: hexInputValue }), hexInputValue ? (h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: this.scale })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
