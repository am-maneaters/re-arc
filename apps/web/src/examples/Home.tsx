...
export default function Home() {
  return (
    <div className="prose dark:prose-invert max-w-none h-full p-4 overflow-auto box-border">
      <h1>Quickstart</h1>
      <p>
        re-arc is a Typescript library that provides React wrappers for the{' '}
        <code>@arcgis/core</code> library, enabling you to build interactive and
        feature-rich mapping applications using React and the ArcGIS JS SDK.
...
pnpm add re-arc`}
      ...
      <h2>Configuration</h2>
      <p>
        re-arc requires that you have both React & the ArcGIS JS API installed
        in your application.
      </p>
      <h2>Basic Usage</h2>
      <p>
        Once you have configured re-arc, you can start using it in your React
        components. Import the necessary components from the re-arc library and
...
const MyMap = () => <ArcMapView zoom={10} center={[-122.4194, 37.7749]} />;
      ...
      <p>
        re-arc provides a wide range of components and utilities that allow you
        to create complex mapping applications. You can explore the example
        projects to learn more about the available components and their usage.
      </p>
      ...
      <ul>
        <li>
          ...
          : Explore the complete documentation for re-arc, including component
          references, usage examples, and guides.
        </li>
        <li>
          <a
      ...
      <p className="italic text-0h">
        ...
        behind ArcGIS. `re-arc` is an independent open-source effort to provide
        ArcGIS integration for React applications. Any reference to
