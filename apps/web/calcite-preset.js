  ...
  theme: {
    ...
    extend: {
      animation: {
        ...
        'in-down':
          'in-down var(--calcite-internal-animation-timing-slow) ease-in-out',
        'in-up':
          'in-up var(--calcite-internal-animation-timing-slow) ease-in-out',
        'in-scale':
          'in-scale var(--calcite-internal-animation-timing-slow) linear',
      },
      borderRadius: {
        half: '50%',
      },
      boxShadow: {
        ...
        '1-lg':
          '0 4px 16px 0 rgba(0, 0, 0, 0.08), 0 2px 8px 0 rgba(0, 0, 0, 0.04)',
        '1-sm':
          '0 1px 6px -1px rgba(0, 0, 0, 0.16), 0 1px 2px -1px rgba(0, 0, 0, 0.08)',
  ...
  plugins: [
    plugin(({ addUtilities }) => {
      const newUtilities = {
        ...
        '.transition-default': {
          transition:
            'all var(--calcite-animation-timing) ease-in-out 0s, outline 0s, outline-offset 0s',
        },
      };
